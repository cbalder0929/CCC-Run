import { RouteSteps } from "./RouteMap";
...
export default function RouteSection() {
  return (
    <section id="route" className="relative overflow-hidden px-5 py-16 sm:px-8 sm:py-24">
      <div className="mx-auto max-w-2xl text-center">
        <div>
          ...
          <p className="mx-auto mt-5 max-w-md font-body text-lg text-ink/70">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-6 border-t-2 border-ink/15 pt-6">
            <div>
